...
Gateway (v1 and v2), RDS, ElastiCache, ELBv2 and SNS** — with secret-shaped values redacted before
...
supporting collectors (ECR, EC2, Secrets Manager, SSM) — and the exit criterion: someone who knows

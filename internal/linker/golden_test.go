...
// own fixtures (kept in sync by a test in discovery), the "tier<n>-cases" are
// written by hand so every rule and decision has a case and a negative case,
// and "real-m1" is a real account's inventory, sanitized.

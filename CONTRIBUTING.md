...
- **Ship a negative case** in the hand-written account for its tier or service
  (`testdata/tier{1,2,3}-cases`, `rds-`, `cache-`, `elb-`, `sns-cases`), a named
  test saying why the case matters (`rules_test.go`, `tier2_test.go`,
  `tier3_test.go`, `rds_test.go`, `cache_test.go`, `elb_test.go`, `sns_test.go`),
  and regenerated goldens:
